...
const partners = [
  ...
  },
  {
    ...
    description:
      "Collaborate on accessibility initiatives and inclusive policies",
  ...
  },
  {
    ...
    description:
      "Support our mission to create impactful assistive technologies",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl max-w-3xl mx-auto text-neutral-500 dark:text-neutral-400">
            Join us in our mission to create transformative assistive
            technologies
          </p>
        </motion.div>
        ...
        <div className="mb-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {partners.map((partner, index) => (
            ...
            >
              ...
              <div
                className="absolute inset-0 rounded-xl bg-gradient-to-r opacity-70 p-0.5"
                style={{
                  backgroundImage: `linear-gradient(to right, var(--tw-gradient-stops))`,
                  backgroundSize: "200% auto",
                  animation: "shimmer 2s linear infinite",
                  ["--tw-gradient-from" as any]: partner.color
                    .split(" ")[0]
                    .replace("from-", ""),
                  ["--tw-gradient-to" as any]: partner.color
                    .split(" ")[1]
                    .replace("to-", ""),
                }}
              />
              ...
              >
                ...
                <div
                  className={`w-10 h-10 rounded-lg mb-4 flex items-center justify-center bg-gradient-to-r ${partner.color} text-white`}
                >
                  {partner.icon}
                </div>
        ...
        >
          ...
          <div className="relative z-10 py-12 px-6 md:py-16 md:px-12 text-center">
            ...
            <p className="text-lg mb-10 max-w-2xl mx-auto text-neutral-600 dark:text-neutral-300">
              We&apos;re looking for partners who share our vision of creating
              accessible technology solutions that empower lives. Your
              collaboration can help us reach more individuals in need.
            </p>
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center items-center">
              ...
              <a
                href="#contact"
                className="text-sm font-medium text-neutral-700 dark:text-neutral-300 hover:text-purple-600 dark:hover:text-purple-400 flex items-center"
              >
