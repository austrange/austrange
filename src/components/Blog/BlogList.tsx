          ...
          <Link href={`/blog/${post.id}`} className="block">
            <div className="bg-white dark:bg-neutral-800 rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300">
              ...
              <div className="p-6">
                ...
                {/* Title */}
                <h3 className="text-xl font-bold mb-3 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors duration-200">{post.title}</h3>
                
                {/* Excerpt */}
                <p className="text-neutral-600 dark:text-neutral-300 text-sm mb-4 line-clamp-2">{post.excerpt}</p>
